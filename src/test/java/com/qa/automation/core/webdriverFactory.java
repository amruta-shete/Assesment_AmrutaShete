...
public class webdriverFactory {
    ...
    public static WebDriver setWebDriverForBrowser(String browser) throws Exception {
        switch(browser.toLowerCase()){
            case "chrome":
		System.setProperty("webdriver.chrome.driver","C:\\Users\\pravin\\eclipse-workspace\\amruta_automation_assignment\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe");
		ChromeOptions opt = new ChromeOptions();
		opt.setBinary("C:\\Users\\pravin\\eclipse-workspace\\amruta_automation_assignment\\chrome-win64 (1)\\chrome-win64\\chrome.exe");
